...
class Tvak_Admin {
    ...
    public static function render_right_sidebar_guide($active_section = 'product_rules') {
        $field_guides = [
            ...
            'hampers' => [
                'title'    => __('Custom Hampers How-To Guide', 'tvak-beauty-kit'),
                'subtitle' => __('Easy step-by-step guide to building designated hamper products without changing normal products.', 'tvak-beauty-kit'),
                'steps'    => [
                    [
                        'num'   => '1',
                        'title' => __('Choose Hamper Shell', 'tvak-beauty-kit'),
                        'text'  => __('Select the WooCommerce product page that should display the hamper builder. This shell product is not added to cart.', 'tvak-beauty-kit'),
                    ],
                    [
                        'num'   => '2',
                        'title' => __('Set Min and Max', 'tvak-beauty-kit'),
                        'text'  => __('Use the minimum and maximum fields to enforce how many child products customers must choose.', 'tvak-beauty-kit'),
                    ],
                    [
                        'num'   => '3',
                        'title' => __('Assign Products', 'tvak-beauty-kit'),
                        'text'  => __('Check each WooCommerce product that belongs inside this hamper. Every included product starts with quantity 1 by default.', 'tvak-beauty-kit'),
                    ],
                    [
                        'num'   => '4',
                        'title' => __('Required vs Optional', 'tvak-beauty-kit'),
                        'text'  => __('Required products cannot be removed. Optional products appear as add-ons only when optional items are enabled.', 'tvak-beauty-kit'),
                    ],
                    [
                        'num'   => '5',
                        'title' => __('Variable Products', 'tvak-beauty-kit'),
                        'text'  => __('If an assigned product has variations, shoppers must choose a valid shade, size, or other option before adding the hamper.', 'tvak-beauty-kit'),
                    ],
                    [
                        'num'   => '6',
                        'title' => __('Cart Result', 'tvak-beauty-kit'),
                        'text'  => __('The final cart contains only selected child products, grouped by hamper metadata for fulfillment.', 'tvak-beauty-kit'),
                    ],
                ],
                'tip' => __('Setup Tip: Create a dedicated product such as "TVAK Personalized Hamper", then configure that product here as the hamper shell.', 'tvak-beauty-kit'),
            ],
